...
const TvFrame = ({ children }: { children: React.ReactNode }) => (
  <Stack align="center" spacing={0}>
    <Box
      border={{ base: '7px solid #0e0b16', md: '10px solid #0e0b16' }}
      borderRadius={{ base: '14px', md: '18px' }}
      overflow="hidden"
      bg="black"
      w={{ base: '190px', sm: '280px', md: '380px' }}
      boxShadow="0 0 70px 12px rgba(147,112,219,0.28)"
    >
      {children}
    </Box>
    <Box w={{ base: '80px', md: '110px' }} h={{ base: '7px', md: '10px' }} bg="#0e0b16" borderRadius="0 0 6px 6px" />
    <Box w={{ base: '130px', md: '180px' }} h="4px" bg="#0e0b16" borderRadius="full" mt="2px" opacity={0.7} />
  </Stack>
);
